...
class AccountTest {
    ...
    void invalid_username_raises_an_error() {
        assertThrows(Exception.class, () ->
                new AccountImpl(null, "test@example.com", "pwd1", new AccountEntriesInMemory()));
    }

    @Test
    void invalid_email_raises_an_error() {
        assertThrows(Exception.class, () ->
                new AccountImpl("test", null, "pwd1", new AccountEntriesInMemory()));
    }

    @Test
    void invalid_password_raises_an_error() {
        assertThrows(Exception.class, () ->
                new AccountImpl("test", "test@example.com", null, new AccountEntriesInMemory()));
    }

    @Test
    void can_login_with_a_valid_password() {
        Account account = new AccountImpl("test", "test@example.com", "pwd1", new AccountEntriesInMemory());
